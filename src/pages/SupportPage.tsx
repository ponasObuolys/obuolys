  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Prisidėkite prie AI edukacijos Lietuvoje – remkite Ponas Obuolys projektą ir padėkite kurti kokybišką turinį apie dirbtinį intelektą lietuvių kalba."
        />
        <meta property="og:title" content="Parama | Ponas Obuolys" />
        <meta
          property="og:description"
          content="Paremkite Ponas Obuolys projektą ir prisidėkite prie kokybiško AI turinio kūrimo lietuvių kalba."
        />
      ...
      <div className="container mx-auto px-4 py-16 max-w-3xl text-center">
        ...
        <p className="text-lg text-gray-700 mb-8">
          Jūsų parama padeda man kurti kokybišką turinį lietuvių kalba apie dirbtinį intelektą –
          straipsnius, įrankius, kursus ir video. Kiekvienas jūsų indėlis yra labai svarbus ir
          vertinamas!
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 border border-gray-200 flex flex-col items-center">
            ...
            <p className="text-gray-600 mb-6 text-center">
              Gaukite išskirtinį turinį, ankstyvą prieigą prie naujienų ir kitų privalumų
              prisijungdami per Patreon.
            </p>
            <a
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 border border-gray-200 flex flex-col items-center">
            ...
            <p className="text-gray-600 mb-6 text-center">
              Paremkite kanalą tiesiogiai per YouTube ir gaukite specialius ženkliukus bei kitus
              narystės privalumus.
            </p>
            <a
        ...
        <p className="text-gray-600 mb-8">
          Jei turite klausimų ar pasiūlymų, susisiekite{" "}
