...
const CustomSolutionsPage = () => {
  ...
  const enhancedProjects = [
    {
      ...
      category: "Logistika",
      problem:
        "Transporto kompanija prarado užsakymų kontrolę, kai augdama pasiekė 400+ krovinių per dieną.",
      solution:
        "Individuali sistema su realiuoju laiku veikiančiu krovinių sekimu, automatiniais pranešimais klientams, maršrutų optimizavimu ir išsamia analitika.",
      results: [
    ...
    },
    {
      ...
      solution:
        "Centralizuota sistema su brūkšninių kodų skenavimu, automatine apskaita, mažų atsargų įspėjimais.",
      results: [
    ...
    },
    {
      ...
      solution:
        "Savitarnos klientų portalas su užsakymų sekimu realiuoju laiku, dokumentų atsisiuntimu, automatiškais pranešimais ir užsakymų istorija.",
      results: [
    ...
    },
    {
      ...
      solution:
        "Automatinė integracija su krovinių sistema, sąskaitų generavimas pagal taisykles, siuntimas el. paštu.",
      results: [
  ...
  const processSteps = [
    {
      ...
      icon: "🔍",
      description:
        "Nemokama pirminio pokalbio konsultacija (30-60 min). Gilesnė jūsų verslo procesų analizė, esamų sistemų įvertinimas, poreikių išsiaiškinimas.",
    ...
    },
    {
      ...
      icon: "🎨",
      description:
        "UI/UX dizaino kūrimas, klikkuojamo prototipo pristatymas, jūsų feedback ir pakeitimai, technologijų pasirinkimas.",
    ...
    },
    {
      ...
      icon: "⚙️",
      description:
        "Iteratyvus kūrimas (kas 1-2 savaitės demonstracija), reguliarūs pažangos pranešimai, testavimas kiekviename etape, jūsų atsiliepimų įtraukimas į procesą.",
    ...
    },
    {
      ...
      icon: "🚀",
      description:
        "Paleidimas į veikiančią aplinką, duomenų perkėlimas (jei reikia), komandos apmokymai, bandomasis paleidimas su realiais vartotojais, oficialus paleidimas.",
  ...
  const usp = [
    {
      ...
      description:
        "Man tai ne darbas - tai aistra. Kiekvienas projektas man asmeniškas iššūkis. Kuriu sistemą taip, tarsi sau - su atidumu detalėms ir dėmesiu kokybei.",
    },
    {
      icon: "⚡",
    ...
    },
    {
      ...
      description:
        "Naudoju naujausias debesijos technologijas (Supabase, Vercel), užtikrinančias greitį ir sklandumą, 99.9% veikimo laiką, automatines atsargines kopijas, lengvą mastelio keitimą, saugumą ir BDAR atitiktį.",
    },
    {
      icon: "👤",
  ...
  const structuredData = {
    ...
    description:
      "Custom verslo sistemų ir įrankių kūrimas - CRM, logistika, automatizacija, analitika",
    provider: {
      "@type": "Person",
      name: "Ponas Obuolys",
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl md:text-2xl text-foreground/80 max-w-4xl mx-auto mb-8">
                Pirmiausia išklausau jūsų iššūkius, tada kuriu įrankį, kuris taps kasdienės veiklos
                dalimi. Specializuojuosi logistikos srityje, bet nebijau sudėtingų verslo
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-center text-foreground/70 mb-12 max-w-2xl mx-auto">
              Daugelis verslų susiduria su tais pačiais iššūkiais. Gera žinia - visi jie
              sprendžiami.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-center text-foreground/80 mb-12 max-w-3xl mx-auto text-lg">
              Ne standartiniai sprendimai su kompromisais. Kuriu programinę įrangą, kuri tiksliai
              atitinka jūsų procesus, integruojasi su esamomis sistemomis ir auga kartu su jumis.
              Naudoju moderniausias debesų technologijas, užtikrinančias greitį, saugumą ir
              patikimumą.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="dark-card text-center">
                ...
                <p className="text-foreground/70">
                  ...
                  apsunkina. Kiekviena funkcija turi tikslą.
                </p>
              </div>
              <div className="dark-card text-center">
                ...
                <p className="text-foreground/70">
                  Naudodamas moderniausias AI technologijas, galiu pristatyti MVP 2-3 kartus
                  greičiau nei tradicinės agentūros.
                </p>
              </div>
              <div className="dark-card text-center">
                ...
                <p className="text-foreground/70">
                  Automatizuodami procesus sutaupysite darbuotojų laiko ir sumažinsite klaidų. ROI
                  pasiekiamas per 6-12 mėnesių.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-center text-foreground/70 mb-12 max-w-3xl mx-auto">
              Visi šie projektai sukurti logistikos srityje, bet jų funkcionalumas gali būti
      ...
      <section className="py-16 md:py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-center text-foreground/70 mb-12 max-w-3xl mx-auto">
              Kainos priklauso nuo projekto sudėtingumo, funkcionalumo ir trukmės. Siūlau tris
              skirtingus paketus:
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-foreground/80 mb-8">
              Užpildykite trumpą formą ir per 24 valandas susisieksiu su jumis. Pirmoji 30-60
              minučių konsultacija nemokama - aptarsime jūsų poreikius, įvertinsime galimybes ir
              sudarysime preliminarų planą.
            </p>
            <button
              onClick={() => setShowForm(true)}
            ...
            <p className="text-sm text-foreground/60 mt-6">
              Jūsų duomenys saugūs. Nesidalinsiu su trečiosiomis šalimis. Susisieksiu per 24 val.
              darbo dienomis.
            </p>
          </div>
        </div>
