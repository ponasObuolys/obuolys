...
import { ImageLoadingContext } from "./image-loading-context";
...
// Context ir tipai perkelti į atskirą modulį `image-loading-context.ts`
...
export const ImageLoadingProvider: React.FC<ImageLoadingProviderProps> = ({ children }) => {
  ...
  return <ImageLoadingContext.Provider value={value}>{children}</ImageLoadingContext.Provider>;
};
