    ...
    <Link to={`/publikacijos/${article.slug}`} className="block">
      <div className="project-card h-full">
        ...
        <div className="flex items-start gap-3 mb-3">
          <div
            className={`w-10 h-10 rounded-lg ${categoryColor} flex items-center justify-center flex-shrink-0`}
          >
            <span className="text-white font-bold text-base">{primaryCategory.charAt(0)}</span>
          </div>
